...
export const BODY_PARTS = {
  head: {
    key: 'head', name: 'Head & Brain', icon: '🧠', status: 'warning',
  ...
  neck: {
    key: 'neck', name: 'Neck & Cervical', icon: '🤛', status: 'moderate',
  ...
  chest: {
    key: 'chest', name: 'Chest & Lungs', icon: '🪴', status: 'warning',
  ...
  core: {
    key: 'core', name: 'Core & Gut', icon: '🪬', status: 'critical',
  ...
  arms: {
    key: 'arms', name: 'Arms & Shoulders', icon: '💪', status: 'fair',
  ...
  legs: {
    key: 'legs', name: 'Legs & Glutes', icon: '🦵', status: 'fair',
  ...
  spine: {
    key: 'spine', name: 'Spine & Posture', icon: '🦴', status: 'moderate',
  ...
  heart: {
    key: 'heart', name: 'Heart & Circulation', icon: '❤️', status: 'warning',
  ...
  liver: {
    key: 'liver', name: 'Liver & Metabolism', icon: '🫘', status: 'critical',
  ...
  kidneys: {
    key: 'kidneys', name: 'Kidneys', icon: '🧠', status: 'warning',
  ...
  hormones: {
    key: 'hormones', name: 'Hormonal System', icon: '🧬', status: 'critical',
  ...
  immune: {
    key: 'immune', name: 'Immune System', icon: '🛡️', status: 'moderate',

...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'dashboards', label: 'Hubs', icon: Menu },
  ...
  },
  {
    ...
    icon: Shield,
    items: [
      { id: 'humanoid', label: '3D Model', icon: Scan },
      { id: 'physique', label: 'Blueprint', icon: Shield },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'projects', label: 'Projects', icon: Menu },
  ...
  },
  {
    ...
    icon: FileText,
    items: [
      { id: 'entertainment', label: 'Media', icon: Moon },
      { id: 'notes', label: 'Notes', icon: FileText },
      { id: 'documents', label: 'Docs', icon: FileText },
      { id: 'databases', label: 'Data', icon: Scan },
    ]
  }
];

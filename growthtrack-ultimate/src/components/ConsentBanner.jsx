...
export default function ConsentBanner() {
  ...
  useEffect(() => {
    ...
    const measure = () => document.documentElement.style.setProperty('--consent-height', `${ref.current.getBoundingClientRect().height + 32}px`);
    measure();
  ...
  return <aside ref={ref} className="consent-banner" aria-label="Privacy choices">
